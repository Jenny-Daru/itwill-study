...
<%--                    => [로그인]을 클릭한 경우 로그인 처리페이지(/userinfo/login) 요청 --%>
<%-- 로그인 사용자 : 환영메세지를 전달하기 위한 JSP 문서 --%>
<%--                  => [회원목록]을 클릭한 경우 회원목록 출력페이지(/userinfo/list)요청 --%>
<%--                  => [로그아웃]을 클릭한 경우 로그아웃 처리페이지(/userinfo/join)요청 --%>
...
<%-- 요청 URL 주소의 경로와 응답 JSP 문서의 경로가 다르므로 리소스 파일은 절대경로로 표현하는 것을 권장 --%>
	...
	<tr>
	  ...
	  <table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
			...
			<td width=100 align=center bgcolor="E6ECDE" height="22">
				<%--<%=loginUserinfo.getName() 님, 방가방가욤♥ --%>
				${loginUserinfo.name } 님, 방가방가욤♥
			</td>
		  </tr>
	  </table>	
	  <br />
	  <table width=590 border="0" cellpadding="0" cellspacing="0" >
		  <tr>
			<td align="center">
				...
				<%-- <% if(loginUserinfo.getStatus()==9) { //로그인 사용자중 관리자에게만 보이게 하기 --%>
